...
if (empty($_SESSION['user_id'])) {
    ...
    $db->next_result();
    $ListaUsuarios = $db->consulta("CALL SP_LIST_USERS()");
    $db->next_result();
    $ListaRoles= $db->consulta("CALL SP_LIST_ROL()");
...
<head>
    ...
    <!-- JS para la asignacion de roles-->
    <script src="../../js/AsignacionRol.js" type="text/javascript"></script>
    <script>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form id="formAsg" name="formAsg" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="Usuario" name="Usuario">
                                        ...
                                        <?php
                                        while ($rowUsers = $db->fetch_array($ListaUsuarios)) {
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="Rol" name="Rol">
                                        <option> Seleccione</option>
                                        <?php
                                        while ($rowRol = $db->fetch_array($ListaRoles)) {
                                            echo "<option value='" . $rowRol['ROL_TIPO'] . "'>" . $rowRol['ROL_TIPO']."</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="box-footer">
                                <button type="submit" id="AsignarR" name="AsignarR" class="btn btn-primary">Asignar
                                </button>
                            </div>
                        </form>
                    </div>
