...
<head>
    ...
    <!-- JS para la verificacion del formulario-->
                        ...
                        <form id="formC" name="formC" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" required="required" class="form-control" id="NombreUsu" name="NombreUsu"
                                           placeholder="Nombre">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Apellido:</label>
                                    <input type="text" required="required"  class="form-control" id="ApellidoUsu" name="ApellidoUsu"
                                           placeholder="Apellido">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Cedula:</label>
                                    <input type="text" required="required"  maxlength="10" minlength="10" class="form-control" id="CI" name="CI"
                                           placeholder="Cedula">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Correo:</label>
                                    <input type="email"  required="required" class="form-control" id="EmailUsu"
                                           placeholder="Correo">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Contraseña</label>
                                    <input type="password" required="required"  class="form-control" id="PassUsu" name="PassUsu"
                            ...
                            <div class="box-footer">
                                <button type="submit" id="CrearUsu" name="CrearUsu" class="btn btn-primary">Crear</button>
                            </div>
                        </form>
                    </div>
                </div>
