...
if (empty($_SESSION['user_id'])) {
    ...
    $db->next_result();
    $ListaUsuariosC = $db->consulta("CALL SP_LISTA_CAMBIOC()");
    $db->next_result();
...
<head>
    ...
    <script src="../../js/CambioContrasenia.js" type="text/javascript"></script>
    <script>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form id="formCambioC" name="formCambioC" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="Usuario" name="Usuario">
                                        ...
                                        <?php
                                        while ($rowUsers = $db->fetch_array($ListaUsuariosC)) {
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" required="required" class="form-control" id="PassUsu"
                                           name="PassUsu"
                            ...
                            <div class="box-footer">
                                <button type="submit" id="AsignarC" name="AsignarC" class="btn btn-primary">Cambiar
                                </button>
                            </div>
                        </form>
                    </div>
