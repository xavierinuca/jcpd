    ...
    <div class="wrapper row0">
        <div class="hoc container clear">
            ...
            <form>
                ...
                <a>Fecha de la Audiencia de Prueba</a><br><br>
                <a>Hora de la Audiencia de Prueba</a><br><br>
                <hr>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <textarea name="res_audiencia" class="form-control" id="res_audiencia" placeholder="XXX"></textarea>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label ">Resumen de la Resolución:</label>
                        <div class="col-sm-5">
                            <textarea name="resum_res" class="form-control" id="resum_res" placeholder=""></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label ">Tipos de Prueba:</label>
                        <div class="col-sm-5">
