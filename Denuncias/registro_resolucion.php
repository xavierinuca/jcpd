            ...
            <form>
                ...
                <div class="form-horizontal" style="margin-bottom: 34%">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <textarea name="resum_resol" class="form-control" id="res_resol"
                                      placeholder="XXXXXXXXXXXXXXXXX"></textarea>
                        </div>
                    </div>
                    <br>
                    <br>

                    <a>REGISTRO DE MEDIDAS ADMINISTRATIVAS</a><br><br>
                    <div class="form-group">
