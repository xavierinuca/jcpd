            ...
            <form>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="control-label ">Fecha de la Audiencia de Prueba:</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        <label class="control-label ">Hora de la Audiencia de Prueba:</label>
                        <div class="col-sm-5">
                            <textarea name="hora_aud_p" class="form-control" id="hora_aud_p" placeholder="00h00"></textarea>
                        </div>
                    </div>
                    <br>
                    <br>
