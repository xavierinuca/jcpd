...
<head>
    ...
    <script src="../js/Denunciante.js"></script>
    ...
    <div class="wrapper row0">
        <div class="hoc container clear">
            ...
            <form id="formDn" name="formDn">
                ...
                <br>
                <?php
                // se muestra el nuemro del caso actual
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control" id="nombreD" placeholder="Ingrese sus nombres" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label ">Apellidos:</label>
                        <div class="col-sm-5">
                            <input class="form-control" id="apellidosD" placeholder="Ingrese sus apellidos" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label ">Número de Cédula:</label>
                        <div class="col-sm-5">
                            <input class="form-control" id="cedula" placeholder="Ingrese Cedula" required="required" minlength="10" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control" id="edad" placeholder="Ingrese sus edad" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label ">Relacion con el Afectado:</label>
                        <div class="col-sm-5">
                            <textarea type="" class="form-control" id="relacionAfec" placeholder="Ingrese los datos" required="required"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class=" col-sm-5">
                            <select class="form-control" id="genero" name="genero">
                                ...
                                <?php
                                //se muestra los diferentes catalogos
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control" id="telefono" placeholder="Ingrese su telefono" required="required" minlength="10" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label ">Email:</label>
                        <div class="col-sm-5">
                            <input type="email" class="form-control" id="email" placeholder="Ingrese sus email" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label ">Observacion:</label>
                        <div class="col-sm-5">
                            <textarea name="observacionD" class="form-control" id="observacionD"
